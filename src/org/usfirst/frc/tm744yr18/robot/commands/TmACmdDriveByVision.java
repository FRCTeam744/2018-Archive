 ...
 */
public class TmACmdDriveByVision extends Command implements TmIpAddrInfoI {
...
//	double m_speed;
    ...
    public TmACmdDriveByVision() {
    	this(null, -1);
    }
    public TmACmdDriveByVision(double time) {
    	this(null, time); //, time, speed);
    }
    public TmACmdDriveByVision(TmCGrpCallbackI callbackObj, double time) {
